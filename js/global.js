...
var servivesSection = document.getElementById("services"); //   var portfolioSection = document.getElementById("portfolio");
//   var contactSection = document.getElementById("contact");

new splide_esm_default.a('.splide').mount();
...
if (document.querySelectorAll('.scrollToContactUs').length > 0) {
  document.querySelectorAll('.scrollToContactUs').forEach(function (link) {
    return link.addEventListener('click', function () {
      scrollTo(aboutSection);
    });
  }); //CHANGE TO CONTACT US WHEN MADE
}
...
for (var i = 0, len = elms.length; i < len; i++) {
  new splide_esm_default.a(elms[i]).mount();
} //  SCROLL ANIMATIONS
